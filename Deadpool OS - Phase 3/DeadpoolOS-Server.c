...
char *deadpoolOptions[NB_OF_OPTIONS] = {"-all", "-F", "-details", "-line"};
char *sysOptions[NB_OF_OPTIONS] = {"-l", "-rf", "aux", "-l"};
        ...
        else
        {
            ...
            else if (pid2 == 0)
            {
                ...
                else if (strcmp(command[0], "countF") == 0)
                {
                    ...
                    char *secondpart[10] = {"wc", "-l", NULL}; // ls | wc -l
                    onePipe(firstpart, secondpart);
                }
                else if (strcmp(command[0], "findAvenger") == 0)
                {
                    char *firstpart[5] = {"cat", "avengers.txt", NULL};
                    char *secondpart[10] = {"grep", command[1], NULL}; // cat Avengers.txt | grep ##  findavenget hh
                    onePipe(firstpart, secondpart);
                }
                else if (strcmp(command[0], "count") == 0)
                {
                    ...
                    char *thirdpart[10] = {"wc", "-l", NULL}; //ls | grep ## | wc -l
                ...
                else if (strcmp(command[0], "listSorted") == 0)
                {
                    ...
                    twoPipe(firstpart, secondpart, thirdpart); //ls | sort | less
                }
